...
func (state *State) PostGetFilteredEmailsCSV(c *gin.Context) {
	...
	// Parse the filter from the JSON body
	...
	// Get the request details (optional, to get the original filename)
